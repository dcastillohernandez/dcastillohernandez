...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=js,ts,html,css,tailwind,react,redux,angular,androidstudio,apple,ubuntu,windows,aws,azure,babel,bash,bitbucket,bootstrap,django,express,figma,git,github,jest,jquery,linux,materialui,mongodb,mysql,nestjs,netlify,nextjs,nodejs,postman,powershell,py,sqlite,styledcomponents,solidjs,vite,vscode)](https://skillicons.dev)
